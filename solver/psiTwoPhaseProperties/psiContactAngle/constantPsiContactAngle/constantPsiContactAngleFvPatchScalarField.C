...
:
    psiContactAngleTwoPhaseFvPatchScalarField(p, iF),
    theta0_(0.0)
{}
...
:
    psiContactAngleTwoPhaseFvPatchScalarField(p, iF, dict),
...
:
    psiContactAngleTwoPhaseFvPatchScalarField(gcpsf, p, iF, mapper),
...
:
    psiContactAngleTwoPhaseFvPatchScalarField(gcpsf),
    theta0_(gcpsf.theta0_)
{}
...
:
    psiContactAngleTwoPhaseFvPatchScalarField(gcpsf, iF),
    theta0_(gcpsf.theta0_)
{}
...
{
    psiContactAngleTwoPhaseFvPatchScalarField::write(os);
