...
const Foam::Enum
<
    Foam::psiContactAngleTwoPhaseFvPatchScalarField::limitControls
>
Foam::psiContactAngleTwoPhaseFvPatchScalarField::limitControlNames_
({
    { limitControls::lcNone, "none" },
    { limitControls::lcGradient, "gradient" },
    { limitControls::lcZeroGradient, "zeroGradient" },
    { limitControls::lcPsi, "psi" },
});


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::psiContactAngleTwoPhaseFvPatchScalarField::
psiContactAngleTwoPhaseFvPatchScalarField
(
    const fvPatch& p,
...
psiContactAngleTwoPhaseFvPatchScalarField
(
    const psiContactAngleTwoPhaseFvPatchScalarField& acpsf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
void Foam::psiContactAngleTwoPhaseFvPatchScalarField::evaluate
(
...
void Foam::psiContactAngleTwoPhaseFvPatchScalarField::write
(
    Ostream& os
) const
{
